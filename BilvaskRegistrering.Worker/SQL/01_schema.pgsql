-- Run as ADMIN (Driver323 / bilvask_admin_app) in database: bilvaskregistrering
...
ALTER TABLE public.ansatter ADD COLUMN IF NOT EXISTS pin TEXT NULL;
ALTER TABLE public.ansatter ADD COLUMN IF NOT EXISTS aktiv BOOLEAN NOT NULL DEFAULT TRUE;
ALTER TABLE public.ansatter ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ NOT NULL DEFAULT now();
